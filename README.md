...
## Datasets
All datasets used and generated by the WAVDesC pipeline and the other denoising pipelines are stored in the [`datasets/`](datasets/) directory.*
- [`Denoised data`](datasets/denoised)
- 
